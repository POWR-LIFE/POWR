 ...
 *  - AppState-driven auto-close once a grant lands
 *  - Linking.openSettings rejection does not surface as an unhandled error
 *  - iOS/Android CTA label variants via Platform.OS stub
 *
 * jest-expo runs as iOS by default; Android CTA labels are tested in a
 * dedicated describe block with Platform.OS stubbed to 'android'.
 */
