        ...
        <div className="px-4 lg:px-0 py-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20">
                <div>
                    ...
                    <h1 className="text-6xl font-light tracking-tighter text-[#1A1A1A] mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-20">
                {[
                    { label: 'Total Applications', value: allStats.total,    icon: Star,        color: '#8a7600', desc: 'ROSTER'   },
                    ...
                    <div
                        key={s.label}
                        className="bg-white border border-[#E6E6E1] p-10 rounded-3xl flex items-center gap-8 group hover:border-[#E6E6E1] transition-all relative overflow-hidden"
                    >
                        ...
                        <button
                            ...
                            className={`h-16 px-10 rounded-full text-[10px] font-black uppercase tracking-[0.3em] transition-all ${
                                filter === f
                                    ...
                                    : 'bg-white border border-[#E6E6E1] text-[#AAAAAA] hover:text-[#666666] hover:border-[#E6E6E1]'
                            }`}
                        >
                            {f}
                            {f === 'pending' && allStats.pending > 0 && (
                                <span className={`ml-3 inline-flex items-center justify-center w-5 h-5 rounded-full text-[9px] font-black ${
                                    filter === 'pending' ? 'bg-[#F4F4F1] text-[#8a7600]' : 'bg-[#f97316] text-white'
                                }`}>{allStats.pending}</span>
                            )}
                        </button>
                    ))}
                </div>
                <div className="text-[10px] uppercase tracking-[0.6em] text-[#BBBBBB] font-black">
                    POWR / ATH / V1.0
                </div>
            </div>
            ...
            <div className="bg-white border border-[#E6E6E1] rounded-3xl overflow-hidden">
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-48 gap-6">
                        ...
                        <span className="text-[10px] uppercase tracking-[0.6em] text-[#666666] font-black">Loading Applications…</span>
                    </div>
                ) : applications.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-48 gap-6">
                        <div className="w-20 h-20 rounded-3xl bg-[#F4F4F1] border border-[#E6E6E1] flex items-center justify-center">
                            <Star size={32} className="text-[#CCCCCC]" />
                        </div>
                        <p className="text-[11px] uppercase tracking-[0.4em] text-[#BBBBBB] font-black">
                            ...
                            <thead>
                                <tr className="bg-[#F4F4F1] border-b border-[#E6E6E1]">
                                    {['Athlete', 'Sports', 'Submitted', 'Status', ''].map(h => (
                                        <th
                                            key={h}
                                            className={`px-6 py-5 text-[10px] font-black uppercase tracking-[0.5em] text-[#AAAAAA] ${h === '' ? 'text-right' : ''}`}
                                        >{h}</th>
                                    ))}
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-[#E6E6E1]">
                                {applications.map(app => (
                                    <tr
                                        ...
                                        className="group hover:bg-[#F4F4F1] transition-all cursor-pointer"
                                    >
                                        {/* Athlete identity */}
                                            ...
                                            <div className="flex items-center gap-6">
                                                <div className="w-12 h-12 rounded-2xl bg-[#F4F4F1] border border-[#E6E6E1] flex items-center justify-center overflow-hidden shrink-0">
                                                    {app.avatar_url
                                                        ...
                                                        : <User size={18} className="text-[#BBBBBB]" />
                                                    }
                                                </div>
                                                <div>
                                                    <div className="text-base font-bold text-[#222222] group-hover:text-[#1A1A1A] transition-colors mb-1">
                                                        {app.display_name || '—'}
                                                    </div>
                                                    <div className="text-[10px] uppercase tracking-[0.3em] text-[#AAAAAA] font-black font-mono">
                                                        {app.email}
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex flex-wrap gap-2">
                                                {(app.activity_preferences ?? []).slice(0, 3).map(p => (
                                                    <span
                                                        key={p}
                                                        className="px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-[0.15em] bg-[#EFEFEC] border border-[#E6E6E1] text-[#AAAAAA]"
                                                    >{p}</span>
                                                ))}
                                                {(app.activity_preferences ?? []).length > 3 && (
                                                    <span className="text-[10px] text-[#BBBBBB] font-black">
                                                        +{app.activity_preferences.length - 3}
                                                    </span>
                                                )}
                                            </div>
                                        ...
                                        <td className="px-6 py-5 whitespace-nowrap">
                                            <div className="text-[12px] text-[#999999] font-medium mb-1">
                                            ...
                                            <div className="flex items-center justify-end gap-3">
                                                {app.status === 'invited' && app.invite_token && (
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-3 px-6 py-3 bg-[#F4F4F1] border border-[#E6E6E1] rounded-full text-[9px] font-black uppercase tracking-[0.3em] text-[#999999] hover:text-[#8a7600] hover:border-[#E8D200]/30 transition-all"
                                                    >
                                                        {copiedId === app.id
                                                ...
                                                {app.status === 'rejected' && (
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-3 px-6 py-3 bg-[#F4F4F1] border border-[#E6E6E1] rounded-full text-[9px] font-black uppercase tracking-[0.3em] text-[#999999] hover:text-[#6366f1] hover:border-[#6366f1]/30 transition-all"
                                                    >
                                                        Re-invite
                                                    </button>
                                                )}
                                                ...
                                                >
                                                    Review
                                                    <span className="text-[#999999] group-hover/btn:text-[#8a7600] transition-colors">›</span>
                                                </button>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div className="mt-12 flex items-center justify-between px-12">
                <div className="flex items-center gap-4">
                    ...
                    <span className="text-[10px] uppercase tracking-[0.6em] text-[#666666] font-black">Pro Network Sync Active</span>
                </div>
            </div>
            ...
            {selected && (
                ...
                >
                    <div
                        className="bg-white border border-[#E6E6E1] rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl"
                        onClick={e => e.stopPropagation()}
                    >
                        {/* Modal header */}
                        <div className="flex items-center justify-between p-10 border-b border-[#E6E6E1] sticky top-0 bg-white z-10">
                            <div className="flex items-center gap-6">
                                <div className="w-14 h-14 rounded-2xl overflow-hidden bg-[#F4F4F1] border border-[#E6E6E1] shrink-0">
                                    {selected.avatar_url
                                        ? <img src={selected.avatar_url} alt="" className="w-full h-full object-cover" />
                                        : <div className="w-full h-full flex items-center justify-center">
                                            <User size={20} className="text-[#BBBBBB]" />
                                          </div>
                                    }
                                </div>
                                <div>
                                    <div className="text-xl font-light tracking-tight text-[#1A1A1A] mb-1">
                            ...
                            <button
                                onClick={() => setSelected(null)}
                                className="w-10 h-10 rounded-full bg-[#EFEFEC] flex items-center justify-center text-[#999999] hover:text-[#1A1A1A] transition-colors"
                            >
                                <X size={16} />
                            </button>
                        </div>
                        ...
                        <div className="p-10 space-y-10">
                            {/* Cover */}
                            {selected.cover_url && (
                                <div className="h-40 rounded-2xl overflow-hidden border border-[#E6E6E1]">
                            ...
                            {selected.bio && (
                                <ModalSection label="Bio">
                                    <p className="text-sm text-[#777777] font-light leading-relaxed">{selected.bio}</p>
                                </ModalSection>
                            )}
                            ...
                            <ModalSection label="Sports">
                                <div className="flex flex-wrap gap-2">
                                    {(selected.activity_preferences ?? []).map(p => (
                                        <span
                                            key={p}
                                            className="px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] bg-[#EFEFEC] border border-[#E6E6E1] text-[#999999]"
                                        >{p}</span>
                                    ))}
                                </div>
                            </ModalSection>
                                ...
                                <ModalSection label="Social">
                                    {selected.instagram_handle && (
                                        <p className="text-sm text-[#888888] font-light">
                                            Instagram: <span className="text-[#666666]">@{selected.instagram_handle}</span>
                                        </p>
                                    )}
                                    {selected.website_url && (
                                        <p className="text-sm text-[#888888] font-light">{selected.website_url}</p>
                                    )}
                                </ModalSection>
                            )}
                                ...
                                <ModalSection label="Achievements">
                                    <div className="space-y-3">
                                        {selected.achievements.map((a, i) => (
                                            <div
                                                key={i}
                                                className="flex items-center gap-6 p-6 rounded-2xl bg-[#F4F4F1] border border-[#E6E6E1]"
                                            >
                                                <span className="text-3xl font-light text-[#8a7600] min-w-[72px] tracking-tighter">
                                                    {a.value}
                                                </span>
                                                <div>
                                                    <div className="text-sm font-medium text-[#222222] mb-1">{a.title}</div>
                                                    {a.context && (
                                                        <div className="text-[11px] text-[#AAAAAA] uppercase tracking-widest font-black">{a.context}</div>
                                                    )}
                                                </div>
                                            </div>
                                        ))}
                                ...
                                <ModalSection label={`Gallery · ${selected.gallery_urls.length} photos`}>
                                    <div className="grid grid-cols-3 gap-3">
                                        {selected.gallery_urls.map((url, i) => (
                                            <div
                                                key={i}
                                                className="aspect-square rounded-2xl overflow-hidden border border-[#E6E6E1]"
                                            >
                                ...
                                <ModalSection label="Invite Link">
                                    <div className="flex gap-3">
                                        <div className="flex-1 h-14 px-6 bg-[#F4F4F1] border border-[#E6E6E1] rounded-2xl flex items-center overflow-hidden">
                                            <span className="text-[11px] text-[#AAAAAA] font-mono truncate">
                            ...
                            <ModalSection label="Reviewer Notes">
                                <textarea
                                    ...
                                    rows={3}
                                    disabled={saving}
                                    className="w-full px-6 py-4 bg-[#F4F4F1] border border-[#E6E6E1] rounded-2xl text-sm text-[#666666] font-light outline-none focus:border-[#E8D200]/30 transition-colors resize-none placeholder-[#BBBBBB] disabled:opacity-50"
                                />
                            </ModalSection>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        {selected.reviewer_notes && (
                                            <div className="text-xs text-[#999999] mt-1 font-light">{selected.reviewer_notes}</div>
                                        )}
                                    </div>
                                </div>
                            )}
