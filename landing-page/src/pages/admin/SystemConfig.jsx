    ...
    return (
        <div className="px-4 lg:px-0 py-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="bg-[#0A0A0A] border border-[#151515] rounded-3xl overflow-hidden">
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-32 gap-6">
                        ...
                        <span className="text-[10px] uppercase tracking-[0.6em] text-[#999] font-black">Loading Config Kernel...</span>
                    </div>
                ) : configs.length === 0 ? (
                    <div className="p-20 text-center">
                        <Settings size={48} className="mx-auto text-[#CCC] mb-6" />
                        <p className="text-[10px] uppercase tracking-[0.4em] text-[#777] font-black">No config parameters found</p>
                    </div>
                ) : (
                            ...
                            return (
                                <div key={c.key} className="flex items-center gap-10 p-10 group hover:bg-[#080808] transition-all">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-[10px] text-[#999] font-black uppercase tracking-[0.3em]">{c.description || 'No description'}</div>
                                    </div>
                                        ...
                                        {isEdited && (
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    className="w-12 h-12 rounded-xl bg-[#050505] border border-[#151515] flex items-center justify-center text-[#999] hover:text-[#F2F2F2] transition-all"
                                                >
                                                    <RotateCcw size={16} />
                                                </button>
                                            </>
            ...
            <div className="mt-8 px-4">
                <p className="text-[9px] uppercase tracking-[0.5em] text-[#777] font-black">
