                    ...
                    {locations.map((loc, i) => (
                        <div key={i} className="bg-[#070707] border border-[#151515] rounded-3xl p-8 space-y-6 animate-in fade-in slide-in-from-top-4 duration-500 relative group/loc">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Node Label / Identifier</label>
                                    <input
                                        type="text"
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Latitude Coordinates</label>
                                    <input
                                        type="text"
                                        inputMode="decimal"
                                        placeholder="-33.8688..."
                                ...
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Longitude Coordinates</label>
                                    <input
                                        type="text"
                                        inputMode="decimal"
                            ...
                            {/* Radius */}
                            <div className="space-y-3">
                                <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Geofence Radius (Meters)</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    placeholder="100"
                ...
                <>
                    ...
                    {formOpen && (
                        <div className="bg-[#070707] border border-[#151515] rounded-3xl p-8 space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Name</label>
                                    <input
                                        type="text"
                            ...
                            <div className="space-y-3">
                                <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Bio</label>
                                <textarea
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Specialties</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Experience</label>
                                    <input
                                        type="text"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Profile URL</label>
                                    <input
                                        type="url"
                                ...
                                <div className="space-y-3">
                                    <label className="block text-[8px] uppercase tracking-[0.5em] text-[#BBB] font-black ml-2">Booking URL</label>
                                    <input
                                        type="url"
