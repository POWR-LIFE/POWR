...
import { Plus, Loader2, CheckCircle, AlertCircle, Users, KeyRound } from 'lucide-react';
        ...
        <div className="bg-white border border-[#E6E6E1] rounded-[2rem] overflow-hidden">
            ...
            <div className="px-8 pb-8 space-y-6">
                <p className="text-[11px] text-[#AAAAAA] font-black leading-relaxed">
                    Give this brand logins for the self-service portal at /partner. Generate a setup
                    link and send it over any channel — they choose their own email and password. Add as
                    many emails as you like; each gets its own login.
                </p>
