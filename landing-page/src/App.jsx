...
import GymLeague from './pages/GymLeague';
        ...
        <ToastProvider>
            <AuthProvider>
                <Routes>
                    ...
                    <Route path="/league/:slug" element={<GymLeague />} />
                    ...
                    <Route path="/admin/studio" element={<ProtectedRoute><AdminLayout><Studio /></AdminLayout></ProtectedRoute>} />
