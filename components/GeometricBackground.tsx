...
export default function GeometricBackground({ opacity = 1 }: GeometricBackgroundProps) {
      ...
      <View style={[StyleSheet.absoluteFill, { opacity }]}>
        ...
        <Svg width={W} height={H} style={StyleSheet.absoluteFill}>
          <Defs>
            ...
            <SvgRadialGradient id="ob_whiteBloom" cx="15%" cy="8%" r="75%">
            ...
            {/* Top-left lit panel */}
            <SvgLinearGradient id="ob_topPanel" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            {/* Right accent panel */}
            <SvgLinearGradient id="ob_rightPanel" x1="100%" y1="0%" x2="40%" y2="100%">
              <Stop offset="0%"   stopColor="#ffffff" stopOpacity="0.05" />
              <Stop offset="100%" stopColor="#ffffff" stopOpacity="0"    />
            </SvgLinearGradient>

            {/* Bottom shadow panel */}
            <SvgLinearGradient id="ob_bottomPanel" x1="0%" y1="0%" x2="100%" y2="100%">
